            ...
            marginRight:"auto"}}
                ...
                <TableContainer component={Paper}>
                    <Table sx={{ minWidth: 700 }} aria-label="customized table">
                        <TableHead>
                            <TableRow>
                                <StyledTableCell align="center">Course tile</StyledTableCell>
                                    ...
                                    return (
                                        <>
                                            <TableBody>
                                                ...
                                                <StyledTableCell align="center">{x.code}</StyledTableCell>
                                                <StyledTableCell align="center">{x.description}</StyledTableCell>
